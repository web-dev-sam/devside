...
export default function DashboardForm({ userName, pfp, role, location, bio }: { userName: string, pfp: string, role: string, location: string, bio: string }) {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    if (values.pfp[0]) {
      formData.append("pfp", values.pfp[0]);
    }
    if (values.role != null) {
    ...
    <>
      <main className="min-h-screen p-8 pb-24">
        <section className="max-w-xl mx-auto space-y-8">
          <h1 className="text-3xl md:text-4xl font-extrabold font-calcom">
            Your Devside
          </h1>
              ...
              <div className="flex-1">
                <Popover open={open} onOpenChange={setOpen}>
                  <PopoverTrigger asChild>
                    ...
                    >
                      {value
                        ? socials.find((social) => social.value === value)?.label
                        : "Select social..."}
                          ...
                          {socials.map((social) => (
                            ...
                            >
                              <Check
                                className={cn(
                                  "mr-2 h-4 w-4",
                                  value === social.value ? "opacity-100" : "opacity-0"
                                )}
                              />
                              {social.label}
                            </CommandItem>
